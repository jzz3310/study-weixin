...
public class Joke {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="87ab4f01e771bda649cc0decd5b62ee5";
    ...
    public static String getNewJoke(){
        ...
        try {
            ...
            result = object.getJSONObject("result").getJSONArray("data").getJSONObject(0).getString("content");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
